  ...
  module.exports = function(grunt) {
    ...
    return {
      'tempbranch': {options: {questions: [{
            ...
            message: function() {
              return 'What remote branch from ' + grunt.config('release.remoteRepository') + ' would like to build your release based on?';
            }
          }]}},
      'build': {options: {questions: [{
      ...
      'pushLocalBranchToUpstream': {options: {
          questions: [{
            config: 'release.remoteDestinationBranch',
            type: 'input',
            message: function() {
              return 'What upstream branch would you like to push ' + grunt.config('release.localBranch') + ' to (probably ' + grunt.config('release.remoteDestinationBranch') + ')? (leave blank to skip)';
            }
          }],
          then: function(answers, done) {
      ...
      'pushLocalBranchToUpstreamMaster': {options: {
          questions: [{
      ...
      'deleteLocalReleaseBranch': {options: {
          questions: [{
