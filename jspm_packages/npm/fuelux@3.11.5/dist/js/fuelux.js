  ...
  (function(factory) {
    ...
    (function($) {
      ...
      var Checkbox = function(element, options) {
        ...
        this.$container = $(element).parent('.checkbox');
    ...
    (function($) {
      ...
      Datepicker.prototype = {
        ...
        checkForMomentJS: function() {
          if (($.isFunction(window.moment) || (typeof moment !== 'undefined' && $.isFunction(moment))) && $.isPlainObject(this.options.momentConfig) && (typeof this.options.momentConfig.culture === 'string' && typeof this.options.momentConfig.format === 'string')) {
            return true;
          } else {
            return false;
          }
        ...
        renderWheel: function(date) {
          ...
          if (this.sameYearOnly) {
            ...
            this.$wheelsYear.removeClass('hide hidden');
          }
    ...
    (function($) {
      ...
      $.fn.search.defaults = {clearOnEmpty: false};
    ...
    (function($) {
      ...
      $.fn.selectlist.defaults = {emptyLabelHTML: '<li data-value=""><a href="#">No items</a></li>'};
    ...
    (function($) {
      ...
      Tree.prototype = {
        ...
        populate: function populate($el) {
          ...
          loader.removeClass('hide hidden');
          this.options.dataSource(treeData ? treeData : {}, function(items) {
            loader.addClass('hidden');
            $.each(items.data, function(index, value) {
              var $entity;
              if (value.type === 'folder') {
                $entity = self.$element.find('[data-template=treebranch]:eq(0)').clone().removeClass('hide hidden').removeData('template');
                $entity.data(value);
                $entity.find('.tree-branch-name > .tree-label').html(value.text || value.name);
              } else if (value.type === 'item') {
                $entity = self.$element.find('[data-template=treeitem]:eq(0)').clone().removeClass('hide hidden').removeData('template');
        ...
        closeFolder: function closeFolder(el) {
          ...
          $branch.find('> .tree-branch-header .icon-folder').eq(0).removeClass('glyphicon-folder-open').addClass('glyphicon-folder-close');
    ...
    (function($) {
      ...
      Pillbox.prototype = {
        ...
        getItemData: function(el, data) {
          return $.extend({text: el.find('span:first').html()}, el.data(), data);
        },
      ...
      Repeater.prototype = {
        ...
        clear: function(options) {
          ...
          if (!viewChanged && viewTypeObj.cleared) {
            viewTypeObj.cleared.call(this, {options: options});
          }
        },
        ...
        infiniteScrolling: function(enable, options) {
          ...
          if (enable) {
            ...
            viewport.css({height: viewport.height() + footer.outerHeight()});
            footer.hide();
          } else {
        ...
        render: function(options) {
          ...
          if (options.changeView && (this.currentView !== options.changeView)) {
            ...
            if (viewTypeObj.selected) {
              viewTypeObj.selected.call(this, {prevView: prevView});
            }
          }
    ...
    (function($) {
      if ($.fn.repeater) {
        ...
        $.fn.repeater.Constructor.prototype.list_createItemActions = function() {
          ...
          if ($actionsTable.length < 1) {
            var selectlist = '<div class="btn-group">' + '<button type="button" class="btn btn-xs btn-default dropdown-toggle" data-toggle="dropdown" data-flip="auto" aria-expanded="false">' + '<span class="caret"></span>' + '</button>' + '<ul class="dropdown-menu dropdown-menu-right" role="menu">' + actionsHtml + '</ul></div>';
      ...
      function renderColumn($tr, row, rowIndex, column) {
        ...
        if (this.viewOptions.list_selectable === 'multi' && column.property === '@_CHECKBOX_@') {
          var checkBoxMarkup = '<label data-row="' + rowIndex + '" class="checkbox-custom checkbox-inline body-checkbox">' + '<input class="sr-only" type="checkbox"></label>';
      ...
      var renderHeader = function renderHeader($tr, column, columnIndex) {
        ...
        if (sortable) {
          ...
          $headerOverlay.on('click.fu.repeaterList', {
            'self': self,
            '$tr': $tr,
